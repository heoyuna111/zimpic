...
방 사진만 촬영하면 사진 속 가구를 분석하여 이사 비용을 자동으로 예측하는 서비스입니다.
...
**Frontend**
- 카카오 맵 API를 활용한 위치 기반 이사 업체 검색 기능 구현
...
<p align="center">
  <img src="./docs/짐픽_아키텍처.PNG" width="900" alt="ZIMPIC 시스템 아키텍처"/>
</p>
...
[ZIMPIC 프로젝트 시연 영상 보러가기](https://youtu.be/mtyF1Sjbees?si=WjrayIzJAr1kcMC4)
